<#   
.SYNTAX
    .\createshortcut.ps1 "$($env:USERPROFILE)\Desktop\dev-dan-firefox" 'C:\Program Files (x86)\x2goclient\x2goclient.exe' '--portable --home=D:\Users\dan\ --hide --sessionid=dev-dan-firefox'
.SYNOPSIS   
